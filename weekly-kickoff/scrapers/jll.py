"""JLL multifamily listing scraper."""
...
class JLLScraper(BaseScraper):
    source_name = "JLL"
    base_url = "https://property.jll.com/search?propertyType=Multifamily&country=US&state=IA"

    def parse_listings(self, page: Page) -> list[PropertyRecord]:
        records = []
        cards = page.locator(
            "[class*='property'], [class*='card'], [class*='result'], article"
        ).all()
